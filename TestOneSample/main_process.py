...
from TestOneSample.load_data_V2 import myDataset, ToTensor

#from Network.SDCNet import SDCNet_VGG16_classify
from TestOneSample.Network.SDCNet import SDCNet_classify
from TestOneSample.Val import test_phase
...
def main(opt):
    ...
    # test settings
    img_dir = os.path.join(root_dir, img_subsubdir)
    tar_dir = os.path.join(root_dir, tar_subsubdir)
    ...
    div_times = 2
    net = SDCNet_classify(class_num, label_indice, div_times=div_times, \
    ...
    if os.path.exists(mod_path):
        ...
        # test
        test_phase(opt, net, testloader, log_save_path=log_save_path)
