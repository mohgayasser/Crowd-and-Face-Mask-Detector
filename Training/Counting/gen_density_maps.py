...
def generate_density_maps(
    ...
    for bn, points in basename2headpoints_dict_part.items():
        ...
        print(bn)
        print(f"{bn}/density_map")
        print(basename2dmap_dict[f"{bn}/density_map"] )
...
def main(cfg):
    for t in ['train_data', 'test_data']:
        the_dir = pjn(
            ...
            t)
        imgs_dir = pjn("/content/drive/MyDrive/SSD/data/SH_partA/test", "images")
        annot_dir = pjn("/content/drive/MyDrive/SSD/data/SH_partA/test", "gtdens")
        ...
        if t == 'test_data':
            xhp_dmaps_dict = xhp_density_maps("/content/drive/MyDrive/Test_Data.zip (Unzipped Files)/Test_Data/SH_partA_Density_map/test/gtdens")
